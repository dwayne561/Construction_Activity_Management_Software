<?php
    ...
    $sql = "SELECT * FROM time_tracker_site_location_select_box";  
...
<body>
    ...
    <div id="apple">
        ...
        <div id="orange">
            <div id="pear">
            <label class="table table-bordered" for="name">Project/Dept Select Box</label>
                <div id ="kiwi">
...
console.log(users);
    ...
    $(document).ready(function() {
        $('.submitBtn').on('click', function() {
            ...
            console.log(myArray);
            $.ajax({
                url: 'sitelocationselectboxinsert.php',
                type: 'post',
